		...
		<el-row :gutter="20" style="height: 100%;">
			...
			<el-col :span="21" style="width: 88%;">
				<el-table :data="tableData" style="width: 100%" height="calc(100vh - 160px)">
					...
					<el-table-column prop="groupId" label="权限组ID" />
					...
					<el-table-column prop="groupCodeParent" label="父权限组编码" />
...
export default {
	...
	methods: {
		...
		async getList() {
			...
			*/
			try {
				const res = await SynchronizeApi.getSynchronizeGroupRecords(this.queryParams);
